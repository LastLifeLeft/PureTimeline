...
; 		Test.s		; Could be added?
	...
	Procedure MoveMediaBlock(*Data.GadgetData, *Block.MediaBlock, Offset)
		...
		If *Block\FirstBlock + Offset < 0
			Offset = -*Block\FirstBlock
		EndIf
		
		If *Block\LastBlock + Offset > *Data\Content_Duration
			Offset = *Data\Content_Duration - *Block\LastBlock
		EndIf
		
		*Block\LastBlock + Offset
		*Block\FirstBlock + Offset
		...
		Select EventType()
			...
			Case #PB_EventType_LeftButtonUp ;{
				...
				ElseIf *Data\Drag_MediaBlock = #Drag_Movement ;{
					ForEach *Data\State_HotMediaBlocks()
						MoveMediaBlock(*Data, *Data\State_HotMediaBlocks(), *Data\Drag_OffsetX)
	...
	Procedure Redraw(Gadget)
		...
		If Not *Data\Draw_Freeze
			...
			;{ Header
			AddPathBox(0,0, *Data\Meas_Header_Width, *Data\Meas_Header_Height)
	...
	Procedure Refit(Gadget)
		...
		Protected VScrollBarVisible, HScrollBarVisible
		...
		*Data\Meas_VisibleColumns = *Data\Meas_Body_Width / *Data\Meas_Body_ColumnWidth
		...
		If VScrollBarVisible
			...
			ResizeGadget(*Data\Comp_VScrollBar, Width - *Data\Meas_VScrollBarWidth, *Data\Meas_Body_VOffset, *Data\Meas_VScrollBarWidth, *Data\Meas_Body_Height - HScrollBarVisible * *Data\Meas_HScrollbarHeight)
		EndIf
